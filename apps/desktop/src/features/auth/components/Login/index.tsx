...
import { LuMail, LuEye, LuEyeOff, LuArrowLeft, LuDatabase } from 'react-icons/lu'
...
export function Login({ onSuccess }: LoginProps) {
    ...
    const renderAuthenticatingView = () => (
        <>
            <LuDatabase size={64} style={{ marginBottom: 16, color: '#4a9eff' }} />
            ...
            <div className="login-card">
                <div className="login-content">
                    {loginSuccess ? (
                        ...
                        <>
                            <LuDatabase size={64} style={{ marginBottom: -8, color: '#4a9eff' }} />
                            <h1 className="login-title">DBX Studio</h1>
