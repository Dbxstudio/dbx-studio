...
interface RedshiftConnectionModalProps {
    isOpen: boolean
    onClose: () => void
    onBack: () => void
...
export function RedshiftConnectionModal({
    isOpen,
    onClose,
    onBack,
    onSaveSuccess,
            ...
            <div className="connection-modal dark-theme">
                ...
                <div className="modal-header">
                    <div className="modal-header-title">
                        <SiAmazonredshift size={24} className="redshift" />
                        <h2>{isEditing ? 'Edit Amazon Redshift Connection' : 'New Amazon Redshift Connection'}</h2>
                    </div>
                    ...
                    <div className="form-grid">
                        ...
                        <div className="form-group">
                            ...
                            <input
                                ...
                                placeholder="cluster-id.region.redshift.amazonaws.com"
                        ...
                        <div className="form-group">
                            ...
                            />
                            <div className="hint">The name of the database to connect to</div>
                        </div>
